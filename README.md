...
4. The demo maps live in the **plugin's** content, so enable Content Browser →
   Settings → **Show Plugin Content** first. Then open a map (under
   *TonConnect Content → Maps*) and press **Play**:
